/* Re-usable visual icons (no emoji).
   Use <Icon name="..." />.  All icons inherit currentColor.
*/
...
window.Icon = function Icon({ name, size = 20, strokeWidth = 2, fill, style, label, className = "" }) {
  const d = ICONS[name] || "";
